//! Q4_K quantized matrix operations
//!
//! This module provides GPU-accelerated operations for Q4_K quantized tensors.
//! Q4_K uses 4-bit quantization with super-blocks of 256 elements.
